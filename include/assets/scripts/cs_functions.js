...
function gll_search_map() {
	...
	var mapOptions = {
		zoom: 11,
		center: new google.maps.LatLng(gllpLatitude, gllpLongitude)
	  };
	
	var map = new google.maps.Map(jQuery("#cs-map-location-id")[0], mapOptions);
...
var Data = [{
	"Class": "column_100",	"title": "100",	"element": ["latest_sermon","sermon","gallery", "slider", "blog","event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"]}, 
	{"Class": "column_75","title": "75",	"element": ["latest_sermon","sermon","gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"]}, 
	{"Class": "column_67","title": "67","element": ["latest_sermon","sermon","gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"]}, 
	{"Class": "column_50","title": "50","element": ["latest_sermon","sermon","gallery", "slider", "blog", "event", "team", "column", "services", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "services", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"]},
...
function _iconSearch(id) {
	   jQuery('#target-'+id).iconpicker({
...
function add_sermon_to_list(admin_url, theme_url) {
	...
	jQuery.ajax({
		...
		success: function(response) {
			...
			jQuery("#sermon_title,#sermon_file_url").val("");
