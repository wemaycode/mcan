		...
		var Data = [
			{ "Class" : "column_100" , "title":"100" , "element" : ["latest_sermon","sermon","gallery", "slider","blog","cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"] },
			{ "Class" : "column_75" , "title" : "75" , "element" : ["latest_sermon","sermon","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"] },
			{ "Class" : "column_67" , "title" : "67" , "element" : ["latest_sermon","sermon","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"] },
			{ "Class" : "column_50" , "title" : "50" , "element" : ["latest_sermon","sermon","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","tabs", "accordion", "advance_search", "prayer","teams","services","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter"] },
			...
			{ "Class" : "column_25" , "title" : "25" , "element" : ["gallery","column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","pastor","services","counter","teams",'services',"flex_column","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq"] },
		];
		...
		function cs_shortcode_element_ajax_call(val, id, admin_url) {
			if (val != "") {
				...
				//jQuery('.shortcodeload').html("<img src='http://irfan/education/wp-content/themes/education-theme/include/assets/images/ajax_loading.gif' />");
				jQuery.ajax({
					type: "POST",
					url: admin_url,
					data: newCustomerForm,
		...
		jQuery(window).on('popstate', function() {
			...
			function SuccessLoader() {
				...
				var loader = "<div class='loader'><i class='fa fa-spin fa-spinner'></i></div>"
