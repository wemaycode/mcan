...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Choose Sub header','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
      ...
      <div class="select-style">
        <select name="header_banner_style" class="dropdown" onchange="javascript:cs_slider_element_toggle(this.value)">
          <option <?php if(isset($header_banner_style) and $header_banner_style=="default_header" || $header_banner_style=="" ){echo "selected";}?> value="default_header" ><?php _e('Default Subheader','Awaken');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="breadcrumb_header" ) {echo "selected";}?> value="breadcrumb_header" ><?php _e('Custom Subheader','Awaken');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="custom_slider"){echo "selected";}?> value="custom_slider" ><?php _e('Revolution Slider','Awaken');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="map"){echo "selected";}?> value="map" ><?php _e('Map','Awaken');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="no-header"){echo "selected";}?> value="no-header" ><?php _e('No Subheader','Awaken');?></option>
        </select>
        <script>
...
<div id="subheader-background-image" style="display:<?php if($header_banner_style=="breadcrumb_header")echo 'inline"'; else echo 'none';?>" >
  ...
  <ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Sub Heading','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
  ...
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Breadcrumbs','Awaken');?></label>
    </li>
    <li class="to-field">
      <label class="pbwp-checkbox">
  ...
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Padding','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
        <div class="select-style">
          <select name="subheader_padding_switch" onchange="javascript:cs_hide_show_toggle(this.value,'cs_padding_type','page_options')">
            <option value="default" <?php if (isset($cs_xmlObject->subheader_padding_switch) and $cs_xmlObject->subheader_padding_switch == "default") echo 'selected="selected"';?>><?php _e('Default','Awaken');?></option>
            <option value="custom" <?php if (isset($cs_xmlObject->subheader_padding_switch) and $cs_xmlObject->subheader_padding_switch == "custom") echo 'selected="selected"';?>>
			<?php _e('Custom','Awaken');?></option>
  ...
  <div id="cs_padding_type" style=" <?php if ( isset($subheader_padding_switch) && $subheader_padding_switch =='custom' ){ echo 'display:block'; } else { echo 'display:none';}?>">
      <ul class="form-elements">
        <li class="to-label"><label><?php _e('Padding Top','Awaken');?></label></li>
        <li class="to-field">
            ...
            <p><?php _e('Set the top padding (In PX)','Awaken');?></p>
        </li>
      </ul>
      <ul class="form-elements">
        <li class="to-label"><label><?php _e('Padding Bottom','Awaken');?></label></li>
        <li class="to-field">
            ...
            <p><?php _e('Set the bottom padding (In PX)','Awaken');?></p>
        </li>
      </ul>
  </div>
  <ul class="form-elements">
...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Show Image','Awaken');?></label>
  </li>
  <li class="to-field">
    <label class="pbwp-checkbox">
...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Parallax Background Image','Awaken');?> </label>
  </li>
  <li class="to-field">
    <label class="pbwp-checkbox">
...
<div id="subheader_custom_slider" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "custom_slider"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
  ...
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Select Slider','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="select-style">
      ...
      <div class="left-info">
        <p><?php _e('Please select Revolution Slider if already included in package. Otherwise buy Sliders from','Awaken');?> <a href="<?php _e('http://codecanyon.net/','Awaken');?>" target="_blank"><?php _e('Codecanyon','Awaken');?></a><?php _e('But its optional','Awaken');?> </p>
      </div>
    </li>
  </ul>
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Select Slider Position','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="select-style">
       <select name="slider_position" id="slider_position">
        <option value="below" <?php echo trim($slider_position) == 'below' ? 'selected="selected"' : '' ;?>><?php _e('Below Header','Awaken');?></option>
      	<option value="above" <?php echo trim($slider_position) == 'above' ? 'selected="selected"' : '' ;?>><?php _e('Above Header','Awaken');?></option>
       </select>
      </div>
    </li>
  </ul>
...
<div id="subheader_map" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "map"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Custom Map Short Code','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
      ...
      <div class="left-info">
        <p><?php _e('Please Add/Edit the short code for Map','Awaken');?></p>
      </div>
    </li>
  </ul>
</div>
...
<div id="subheader_no_header" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "no-header"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Header Border Color','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
    ...
    <div class="input-sec">
      <div class="select-style">
        <select name="cs_background_option" class="dropdown"  onchange="javascript:cs_background_settings_toggle(this.value)">
          <option <?php if($cs_background_option=='no-image') echo "selected";?> value="no-image"> <?php _e('No Image','Awaken');?></option>
          <option <?php if($cs_background_option=='custom-background-image') echo "selected";?> value="custom-background-image"> <?php _e('V1 Custom Background Image','Awaken');?></option>
          <option <?php if($cs_background_option=='big-image-zoom') echo "selected";?> value="big-image-zoom"> <?php _e('V2 Big Image Zoom','Awaken');?></option>
          <option <?php if($cs_background_option=='fade-slider') echo "selected";?> value="fade-slider"><?php _e('V3 Fade Slider','Awaken');?></option>
          <option <?php if($cs_background_option=='left-slider')echo "selected";?> value="left-slider"><?php _e('V4 Left Slide','Awaken');?></option>
          <option  <?php if($cs_background_option=='background_video')echo "selected";?> value="background_video" ><?php _e('V6 Video','Awaken');?></option>
        </select>
      </div>
    </div>
  </li>
...
<div class="form-elements meta-body noborder" style=" <?php if($cs_background_option == "background_video"){echo "display:block";}else echo "display:none";?>" id="home_v2" >
  ...
  <ul class="form-elements noborder">
    <li class="to-label">
      <label><?php _e('Choose Mute','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
        <div class="select-style">
          <select name="cs_home_v2_video_mute" class="dropdown">
            <option value="Yes" <?php if($cs_home_v2_video_mute == "Yes"){ echo 'selected';}?>><?php _e('Yes','Awaken');?> </option>
            <option value="No" <?php if($cs_home_v2_video_mute == "No"){ echo 'selected';}?>> <?php _e('No','Awaken');?></option>
          </select>
        </div>
      </div>
    </li>
...
<div class="form-elements meta-body noborder" style=" <?php if($cs_background_option == "big-image-zoom" || $px_theme_option['varto_bg_option'] == "fade-slider" ||  $px_theme_option['varto_bg_option'] == "left-slider"){echo "display:block";}else echo "display:none";?>" id="home_v4" >
  <ul class="form-elements noborder">
    <li class="to-label">
      <label><?php _e('Choose Slider/Gallery','Awaken');?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
        <div class="select-style">
      ...
      <div class="left-info">
        <p><?php _e('Slider/Gallery images resolution should befull size. Create new Slider/Gallery from','Awaken');?> <a style="color:#06F; text-decoration:underline;" href="<?php echo get_site_url(); ?>/wp-admin/post-new.php?post_type=cs_gallery"><?php _e('here','Awaken');?></a></p>
      </div>
    </li>
  </ul>
</div>
...
<ul class="form-elements ">
  <li class="to-label">
    <label><?php _e('Seo Description','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
...
<ul class="form-elements ">
  <li class="to-label">
    <label><?php _e('Seo Keywords','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
...
if ( ! function_exists( 'cs_header_postition_element' ) ) {
	function cs_header_postition_element(){
        ...
        <ul class="form-elements ">
          <li class="to-label">
            <label><?php _e('Header Background','Awaken');?></label>
          </li>
          <li class="to-field">
            <div class="input-sec">
              	<select name="header_bg_options" class="dropdown" onchange="javascript:cs_header_option(this.value)">
                	...
                	<option <?php cs_selected($header_bg_options,'cs_rev_slider') ?> value="cs_rev_slider" ><?php _e('Revolution Slider','Awaken');?></option>
                	<option <?php cs_selected($header_bg_options,'cs_bg_image_color') ?> value="cs_bg_image_color" ><?php _e('Background Image / Background Color','Awaken');?></option>
            	</select>
            </div>
          </li>
        </ul>
...
<ul class="form-elements noborder">
  <li class="to-label">
    <label><?php _e('Custom Classes','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
...
<ul class="form-elements noborder">
  <li class="to-label">
    <label><?php _e('Sub Header Color','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
...
<ul class="form-elements noborder">
  <li class="to-label">
    <label><?php _e('Header Color','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Choose Sidebar','Awaken');?> </label>
  </li>
  <li class="to-field">
    <div class="input-sec">
      <div class="meta-input pattern">
        <div class='radio-image-wrapper'>
          ...
          <span class="title-theme"><?php _e('full width','Awaken');?></span> </div>
        <div class='radio-image-wrapper'>
          ...
          <span class="title-theme"><?php _e('Sidebar Right','Awaken');?></span> </div>
        <div class='radio-image-wrapper'>
          ...
          <span class="title-theme"><?php _e('Sidebar Left','Awaken');?></span> </div>
      </div>
    </div>
  </li>
</ul>
...
<?php
    ...
    <div class="left-info">
      <p> <?php _e('Add New Sidebar','Awaken');?> <a href="<?php echo admin_url();?>themes.php?page=cs_options_page#tab-sidebar-show" target="_blank"><?php _e('Click Here','Awaken');?></a></p>
    </div>
  </li>
</ul>
...
function cs_pagebuilder_themeoptions(){
    ...
    <ul class="form-elements">
      <li class="to-label">
        <label> <?php _e('Page Options','Awaken'); ?> </label>
      </li>
      <li class="to-field">
        <div class="input-sec">
          <div class="select-style">
             ...
             <select name="cs_page_options" class="select_dropdown" id="cs_page_options">
                    <option><?php _e('default','Awaken');?></option>
                    <?php
...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Background Skin','Awaken');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
      <div class="select-style">
        <select name="cs_background_skin">
          <option value="light" <?php if($cs_background_skin == 'light'){echo 'selected="selected"';}?>><?php _e('Light','Awaken');?></option>
          <option value="dark" <?php if($cs_background_skin == 'dark'){echo 'selected="selected"';}?>><?php _e('Dark','Awaken');?></option>
        </select>
      </div>
    </div>
  </li>
