                    ...
                    <div class="tabs vertical">
                        <nav class="admin-navigtion">
                            <ul id="myTab" class="nav nav-tabs">
                                <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="fa fa-toggle-right"></i><?php _e('General Settings','Awaken');?></a></li>
                                <li><a href="#tab-subheader-options" data-toggle="tab"><i class="fa fa-list-alt"></i><?php _e('Sub Header Options','Awaken');?> </a></li>
                                ...
                                <?php }?>
                                <li><a href="#tab-post-options" data-toggle="tab"><i class="fa fa-list-alt"></i> <?php _e('Post Settings','Awaken');?> </a></li>
			...
			if( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return;
 			...
 			if ( ! function_exists( 'cs_blog_post_general_options' ) ) {
				function cs_blog_post_general_options() {
                    ...
                    <li class="to-label"><label><?php _e('Thumbnail View','Awaken');?></label></li>
                    <li class="to-field">
                    	<div class="input-sec">
                            <div class="select-style">
                                <select name="post_thumb_view" class="dropdown" onchange="javascript:new_toggle(this.value)">
                                    <option <?php if($post_thumb_view=="Single Image")echo "selected";?> ><?php _e('Single Image','Awaken');?></option>
                                    <option <?php if($post_thumb_view=="Slider")echo "selected";?> ><?php _e('Slider','Awaken');?></option>
                                </select>
                            </div>
                        </div>
                        <div class="left-info">
                        	<p id="post_thumb_image" style="display:<?php if($post_thumb_view=="Single Image" or $post_thumb_view == "")echo 'inline"';else echo 'none';?>"><?php _e('Use Featured Image as Thumbnail','Awaken');?></p>
                        </div>
                    </li>
                        <ul class="form-elements" id="post_thumb_audio" style="display:<?php if($post_thumb_view=="Audio")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label><?php _e('Audio Url','Awaken');?></label></li>
                            <li class="to-field">
                            	<div class="input-sec">
                        ...
                        <ul class="form-elements" id="post_thumb_video" style="display:<?php if($post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label><?php _e('Thumbnail Video Url','Awaken');?></label></li>
                            <li class="to-field">
                            	<div class="input-sec">
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Inside Post Thumbnail View','Awaken');?></label></li>
                        <li class="to-field">
                            <div class="input-sec">
                                <div class="select-style">
                            ...
                            <div class="left-info">
                                <p id="inside_post_thumb_image" style="display:<?php if($inside_post_thumb_view=="Single Image" or $inside_post_thumb_view=="")echo 'inline"';else echo 'none';?>"><?php _e('Use Featured Image as Thumbnail','Awaken');?></p>
                            </div>
                        </li>
