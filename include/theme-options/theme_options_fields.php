		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case "upload favicon":
					...
					$output .= '<label class="cs-browse"><input id="log" name="'.$value['id'].'" type="button" class="uploadfile left" value="Browse"/><i class="fa fa-upload"></i></label></div></li></ul>';
											...
											if ( $display =='block' ){
												...
												foreach($val['sidebar'] as $sidebar){
													$output.='<tr id="sidebar_'.$i.'">
														...
														<td class="centr"> <a class="remove-btn" onclick="javascript:return confirm(\'Are you sure! You want to delete this\')" href="javascript:cs_div_remove(\'sidebar_'.$i.'\')" data-toggle="tooltip" data-placement="top" title="Remove"><i class="fa fa-times"></i></a>
													</td>
												</tr>';
											$i++;
											}
					...
					$output.='<ul class="form-elements">
								...
								<li style="padding: 10px 0px 20px;" class="full">
								 <ul id="cs_infobox_networks'.$counter.'">
									...
									<li class="to-field">'.cs_fontawsome_theme_options("","networks".$counter).'
									  <input id="social_net_awesome_input" type="hidden" class="cs-search-icon-hidden" name="social_net_awesome_input" value="">
									</li>
								 </ul>
								</li>
													  ...
													  <li><a onclick="cs_toggle(\''.str_replace(' ','-',$social_net_tooltip[$i]).'\')"><img src="'.get_template_directory_uri().'/include/assets/images/close-red.png" /></a></li>
														  ...
														  <li style="padding: 0px 0px 20px;" class="full">
															 <ul id="cs_infobox_theme_options'.$i.'">
																...
																<li class="to-field">'.cs_fontawsome_theme_options($network_list[$i],"theme_options".$i).'
																  <input id="social_net_awesome'.$i.'" type="hidden" class="cs-search-icon-hidden" name="social_net_awesome[]" value="'.$network_list[$i].'">
																</li>
															 </ul>
															</li>
														  <li class="to-label">
